...
function ContactsSidebar() {
	...
	return (
		<aside className="w-10 min-h-[18rem] max-h-[calc(100%-4rem)] py-8 flex flex-col gap-y-8 justify-center items-center text-beige-100 fixed left-0 top-1/2 -translate-y-1/2 bg-coffee-100 rounded-r-xl font-sfmono text-xs">
